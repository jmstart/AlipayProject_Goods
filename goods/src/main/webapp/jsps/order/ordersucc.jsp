...
<div class="div2">
	...
	<dl>
		...
		<dd>${orderpovo.oid}</dd>
		<dt>合计金额</dt>
		<dd><span class="price_t">&yen;${orderpovo.total }</span></dd>
		<dt>收货地址</dt>
		<dd>${orderpovo.address }</dd>
	</dl>
	<span>感谢您的支持，祝您购物愉快！</span>
	<a href="<c:url value='/order/prePay.action?oid=${orderpovo.oid}&total=${orderpovo.total}'/>" id="linkPay">支付</a>
</div>
  </body>
</html>