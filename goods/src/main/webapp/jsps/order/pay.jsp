...
<div class="divBank">
	...
	<div style="margin: 40px;">
		<a href="/goods/order/pay.action?oid=${order.oid}&total=${order.total}" class="linkNext"  target="_BLANK">下一步</a>
	</div>
	<script type="text/javascript">
		/* function  pay(){
			location.href="/goods/order/pay.action?oid=${order.oid}&total=${order.total}";
