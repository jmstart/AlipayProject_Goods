...
<html>
  <head>
	...
	<script type="text/javascript" src="<c:url value='/jsps/js/user/regist.js'/>" charset="utf-8"></script>
  </head>
...
<div id="divMain">
  ...
  <div id="divBody">
  <form action="/goods/user/regist.action" method="post" id="registFrm">
    <table id="tableForm">
      <tr>
      ...
      <tr>
        <td></td>
        <td>
          <div id="divVerifyCode"><img id="imgVerifyCode" src="<c:url value='/user/getVerify.action'/>"/></div>
        </td>
        <td>
